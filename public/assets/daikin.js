...
function set_mode(mode) {
    ...
    switch (mode) {
        case 0:
            document.getElementById("mode_auto").className =
                "btn btn-info mode-btn";
            break;
        case 2:
            document.getElementById("mode_dehum").className =
                "btn btn-info mode-btn";
            break;
        case 3:
            document.getElementById("mode_cooling").className =
                "btn btn-info mode-btn";
            break;
        case 4:
            document.getElementById("mode_heating").className =
                "btn btn-info mode-btn";
            break;
        case 6:
            document.getElementById("mode_fan").className =
                "btn btn-info mode-btn";
            break;
        default:
...
function set_fan(f_mode) {
    switch (f_mode) {
        case 1:
            document.getElementById("fan_auto").className =
                "btn btn-info fan-btn";
            break;
        case 2:
            document.getElementById("fan_eco").className =
                "btn btn-info fan-btn";
            break;
        case 3:
            set_fan_img(1);
...
function set_alert(boolean, mex) {
    ...
    if (boolean) {
        ...
        alert.className = "sr-only alert alert-danger";
...
function update() {
    ...
    if (!request_control_loading) request_control();
    if (!request_sensor_loading) request_sensor();
}
